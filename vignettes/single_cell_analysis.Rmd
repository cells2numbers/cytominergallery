...
- the single-cell data `110000106828.sqlite` have 
...
backend <- file.path(Sys.getenv("HOME"), "Downloads", "110000106828.sqlite")
...
Before aggregating the data, let's filter it down to a couple of wellw and 
plot thehistogram of a single feature:
